...
public class SimilarityAssessor {
	...
	public static void main(String[] args) {
		...
		try
	    {
			...
			System.out.println("similarity between company and subsidiary:  " + _assessor.getSimilarity ( "company" , "subsidiary" ) ) ;
			System.out.println("similarity between bird and mouse:  " + _assessor.getSimilarity ( "bird" , "mouse" ) ) ;
			System.out.println("similarity between bird and tree:  " + _assessor.getSimilarity ( "bird" , "tree" ) ) ;
	    }
	    catch ( Exception ex )
	    {
	      ex.printStackTrace () ;
